...
class TaskRunner(object):
    ...
    def find_and_execute_task(self, task_registry, task_name, **kwargs):
        '''
...
class Worker(object):
    ...
    def __init__(self, auto_discover=False, task_runner=None, task_registry=None):
        ...
        self.runner = task_runner if task_runner else TaskRunner(auto_discover)
    ...
    def start(self):
        ...
        try:
            while True:
                ...
                self.runner.find_and_execute_task(self.tasks, task_name, **kwargs)
